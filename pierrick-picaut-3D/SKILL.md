...
### 一手来源（此人直接产出）
- P2design Academy 课程页面（p2design-academy.com）
- ArtStation 简历与作品集（pieriko.artstation.com）
- Blender Community 教育帖子（blender.community/p2design）
- BlenderNation 作者页面（blendernation.com/author/p2design）
- CG Cookie 免费课程
- Gumroad 产品页面
...
- 网易、CG Staion等中文媒体报道
- B站学习者笔记和评价
- Blender.fi、digitalproduction.com 报道
- CGI Academy Hub 收录

### 关键引用

> "I am a self taught 3D artist, so I know what it takes to learn this amazing craft." —— P2design Academy 课程页面

> "Getting access to educational animation content is generally quite expensive and often difficult to know where to start." —— Alive! 课程公告

> "you will be able to transfer all these techniques to any other software or animation medium" —— Alive! 课程公告

> "Once the camera position is set, I only animate the character, creating a better 2D look and making any further editing way simpler" —— LinkedIn 技术分享

> "I use smears and distorsion to induce speed variations" —— LinkedIn 技术分享
